...
def prepare(source, destination, *, t25_source=None, t25_prior_overlay=None):
    ...
    report = {
        ...
        'task': {'loss': 'mean pinball at alpha=0.001,...,0.999',
            ...
            'fixed_length_interface': {'requested_min_seq_len': 4096, 'requested_max_seq_len': 4096,
                'effective_prior_min_seq_len': None, 'effective_prior_max_seq_len': 4096,
                'normalization': 'equal min/max uses native T25 min_seq_len=None sentinel'},
