...
def main():
    d.configure_common()
    c = d.common
    parent, attempt = '204827', 'row185_retry1'
    ...
    script = 'pfn_mitra8_row185_retry.py'
    plan.pop('plan_id')
    ...
    plan['worker_sha256']['mitra_row185_retry_plan.py'] = c.digest(c.REPO / 'mitra_row185_retry_plan.py')
    plan['plan_id'] = hashlib.sha256(json.dumps(plan, sort_keys=True).encode()).hexdigest()
    path = d.ROOT / 'plan_row185_retry1.json'
